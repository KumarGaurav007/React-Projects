...
<div class="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs rounded
-2xl mb-5">
    <a href="#">
        <img className="rounded-base rounded-t-2xl-2xl" src={props.imageLink} alt="" />
    </a>
    <div class="p-6 text-center">
        ...
        <a href="#">
            <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">{props.courseName}.</h5>
        </a>
